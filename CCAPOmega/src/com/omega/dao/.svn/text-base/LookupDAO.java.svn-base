...
/** Logger */
            ...
            throws SQLException
    {
        ...
        if (LOGGER.isDebugEnabled())
        {
			...
			System.out.println("SCM Plugin ---LOG");
		...
		if(type==null){
			System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!---TYPE NULLLLLLLLLLLLLL");
		}
		if(type!=null && type.startsWith("bala")){
			System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!---TYPE NULLLLLLLLLLLLLL");
		}
		if(type!=null && type.startsWith("dharbala")){
			System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!---TYPE NULLLLLLLLLLLLLL");
		}
		if(type!=null && type.startsWith("chitdharbala")){
			System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!---TYPE NULLLLLLLLLLLLLL");
		}
