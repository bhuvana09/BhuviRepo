...
public class InValidVehicleException extends Exception
{
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(InValidVehicleException.class);
     ...
     */
    public InValidVehicleException(String exceptionCode, String exceptionContext)
    {
     ...
     */
    public InValidVehicleException(String exceptionCode,
            String exceptionContext, Throwable cause)
    {
    ...
    /**
     * 
     * TODO explain the business in the method input , output parameters thrown
     * exceptions
     * @return string
     */
